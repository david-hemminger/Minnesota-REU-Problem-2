...
\begin{rem}
There are several other results related to $\mathcal E(C_n),\mathcal E(D_n),$ with $C_n = \mathbb Z/n\mathbb Z$, which are proven in \cite[Sections 7]{reu_report}. Notably, we showed 
\begin{enumerate}
