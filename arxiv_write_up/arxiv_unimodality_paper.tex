...
\todo{We can reference our other paper online, or perhaps find a better reference for this? In the other paper, we said: This is a well known fact, proven later in Lemma \ref{lem:young_diag_reps}.}
...
\todo{Why is point 2 being singled out in this remark? Doesn't Peckness apply to all three actions from proposition 1.6?}
...
\todo{refer to our other paper here perhaps}
