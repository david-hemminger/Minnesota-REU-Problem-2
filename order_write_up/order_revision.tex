...
\todo[inline]{Section 2 - give a reference for these standard definitions you are reviewing}
...
\todo{pp. 5-6:  The digression on atomistic lattices should be deleted. -- I'm inclined to agree with this, but could be convinced otherwise - David}
\begin{remark}
...
\todo{Corollary 3.13:  Start the list of self-dual posets with $B_n/G$.}
\begin{corollary}
