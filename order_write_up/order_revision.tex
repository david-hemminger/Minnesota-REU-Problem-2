...
``Peck'' was coined in Stanley's paper ~\cite{quotients_stanley}. However, Peck posets were studied prior to this article, ~\cite{quotients_stanley} such as in
~\cite{weyl_groups_stanley}. The property of being Peck is particularly nice
as it has many equivalent definitions, such as those in
