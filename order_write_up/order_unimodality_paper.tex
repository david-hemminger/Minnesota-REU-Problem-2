...
Note that we have also developed several generalizations of $\mathcal E$, for which many similar results hold. For more information, see http://www.math.umn.edu/reiner/REU/HemmingerLandesmanYao2014.pdf, Subsection 3.3.
...
\begin{remark}
There are several other results related to $\mathcal E(C_n),\mathcal E(D_{2n})$, with $C_n = \mathbb Z/n\mathbb Z$, which are proven in http://www.math.umn.edu/reiner/REU/HemmingerLandesmanYao2014.pdf, Section 7. Notably,
\begin{enumerate}
...
\begin{remark}
Observe that Theorem \ref{thm:cover_transitive_implies_Peck} trivially implies that $\mathcal E(B_n)$ is Peck. In fact, it is true that $\mathcal E(B_n)$ is unitary Peck. For a proof, see http://www.math.umn.edu/reiner/REU/HemmingerLandesmanYao2014.pdf, Section 8.
\end{remark}
...
As mentioned in the introduction, a natural extension of Conjecture ~\ref{conj:F_of_BnG_Peck} would be an analogous result for q-analogs. We suspect the method used in \newline
http://www.math.umn.edu/reiner/REU/HemmingerLandesmanYao2014.pdf, Section 8 to prove $\mathcal E(B_n)$ is unitary peck may solve Question ~\ref{question:unitary_peck_q_edge}.
