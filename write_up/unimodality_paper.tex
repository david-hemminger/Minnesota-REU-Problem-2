...
\end{lem}
\begin{proof}
This follows immediately from the fact that $\mathcal E^r(P)$ is graded and Remark \ref{rem:order_containment}.
...
\todo{David, once again, the proof of this Lemma is the same as one that we need for $\mathcal E$ section, so you can probably put this proof there, and feel free to replace this proof by "similarly to the proof for F..."}
\begin{lem}
