...
\newtheorem*{prop:semidirect_product_cover_transitive_actions}{Proposition \ref{prop:semidirect_product_cover_transitive_actions}}
\begin{prop:semidirect_product_cover_transitive_actions}
Let $G\subseteq \operatorname{Aut}(P)$, $H\triangleleft G$, $K\subset G$ such that $G = H\rtimes K$.  Suppose that the action of $H$ is on $P$ is CCT and the action of $K$ on $P/H$ is CCT. Then the action of $G$ on $P$ is CCT.
\end{prop:semidirect_product_cover_transitive_actions}
