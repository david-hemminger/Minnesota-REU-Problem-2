...
\todo{Make the following comments/questions about the functor of edges: 1. Does it have a one sided inverse or adjoint? 2. It is not injective (square minus one edge and square minus 2 edges) 3. Is it surjective? (I think so, can look for edge posets of boolean 2 subalgebras) 4. Does it have a one sided inverse functor, or an adjoint?} 
